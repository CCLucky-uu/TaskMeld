...
const makeGroupWorkflow = (overrides?: { joinPolicy?: WorkflowGroup["joinPolicy"] }): WorkflowDefinitionRuntime => ({
  version: "3.0",
  scheduler: {
    enabled: true,
    mode: "auto",
...
const run = async () => {
  ...
  // ====== Test 4: Group members and artifact references ======
  {
    ...
    const a1 = {
      ...
      schemaVersion: 1,
      name: "patch-a",
      path: join(artifactDir, "patch-a.json"),
      hash: "h1",
      sourceNodeId: "pa",
    ...
    const a2 = {
      ...
      schemaVersion: 1,
      name: "patch-b",
      path: join(artifactDir, "patch-b.json"),
      hash: "h2",
      sourceNodeId: "pb",
      createdAt: new Date().toISOString(),
    }
