  ...
  return async () => ({
    app: {
      ...
      agentService: {
        ...
        sendMessage: async () => ({ ok: true }), getSessionHistory: async () => [], sendMessageAndWaitForReply: async () => ({ sent: {}, reply: null }), createAgent: async () => ({}), updateAgent: async () => ({}), deleteAgent: async () => ({}),
      },
      sessionService: {
        listSessions: async () => [],
