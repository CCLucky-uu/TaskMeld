...
export function TopBar({
  ...
  const panelIcon = (side: "left" | "right", collapsed: boolean) => (
    <svg viewBox="0 0 16 16" width="14" height="14" aria-hidden="true">
      ...
      {side === "left" ? (
        <rect x="2.5" y="2.5" width="4.5" height="11" rx="1" fill={collapsed ? "none" : "currentColor"} stroke="currentColor" strokeWidth="1" />
      ) : (
        <rect x="9" y="2.5" width="4.5" height="11" rx="1" fill={collapsed ? "none" : "currentColor"} stroke="currentColor" strokeWidth="1" />
      )}
    </svg>
  );
