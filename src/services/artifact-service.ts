...
import { planCleanup, executeCleanup, cleanupEmptyDirs, type CleanupPlan, type CleanupOptions } from "../artifacts/artifact-cleanup";
...
export type ArtifactService = {
  ...
  executeCleanup: (pipelineId: string, plan: CleanupPlan) => Promise<{ deleted: number; failed: number; warnings: string[] }>;
};
