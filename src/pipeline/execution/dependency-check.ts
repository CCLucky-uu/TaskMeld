...
export const isDependencySatisfied = (itemKey: string, edge: DependencyEdge, ctx: DependencyCheckContext): boolean => {
...
export const canNeverSatisfy = (itemKey: string, edge: DependencyEdge, ctx: DependencyCheckContext): boolean => {
