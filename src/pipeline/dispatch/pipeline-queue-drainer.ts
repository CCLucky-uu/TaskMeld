...
type DrainerDeps = {
  ...
  executeInboundJob: (job: { jobId: string; linkId: string; upstreamOutput: NonNullable<ReturnType<PipelineInboundQueue["getJobById"]>>["upstreamOutput"] }) => Promise<{ ok: boolean; runId: string | null; error?: string }>;
};
