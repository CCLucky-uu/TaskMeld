...
export function createAgentTools(agent?: AgentService): Tool[] {
  return [
    ...
    },
    {
      ...
      parameters: {
        ...
        properties: {
          ...
          role: {
            type: "string",
            description: "Agent role (coder, reviewer, planner, tester, operator)",
            enum: ["coder", "reviewer", "planner", "tester", "operator"],
          },
      ...
      async execute(_args) {
        return {
          output: "Agent creation is not yet wired to the service layer. Use the TaskMeld UI to create agents.",
          isError: true,
        }
      },
    },
    {
      ...
      async execute(_args) {
        return {
          output: "Agent update is not yet wired to the service layer. Use the TaskMeld UI to update agents.",
          isError: true,
        }
      },
    },
    {
      ...
      async execute(_args) {
        return {
          output: "Agent deletion is not yet wired to the service layer. Use the TaskMeld UI to delete agents.",
          isError: true,
        }
      },
    },
